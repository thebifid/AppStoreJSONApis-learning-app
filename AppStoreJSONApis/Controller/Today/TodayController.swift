...
class TodayController: BaseListController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        collectionView.backgroundColor = #colorLiteral(red: 0.9410942197, green: 0.9412292838, blue: 0.9410645962, alpha: 1)
    ...
    @objc func handleRemoveView(gesture: UITapGestureRecognizer) {
        ...
        if let tapBarFrame = self.tabBarController?.tabBar.frame{
            self.tabBarController?.tabBar.frame.origin.y = self.view.frame.size.height - tapBarFrame.height
        }
    }
